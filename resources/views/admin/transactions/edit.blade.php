                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.transactions.update', $transaction) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="total_amount" id="total_amount" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('total_amount', $transaction->total_amount) }}">
                            @error('total_amount')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
